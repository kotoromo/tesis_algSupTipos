...
\subsection{Teoría de tipos dependientes}
    ...
    \subsubsection{Funciones dependientes}
        ...
        \begin{definition}[tipo de funciones dependientes]
            ...
            \begin{center}
                \AxiomC{$\Gamma, x : A \vdash B(x)\ \type$}
                \UnaryInfC{$\Gamma \vdash \prod\limits_{x : A}B(x)\ \type$}
                \DisplayProof
            \end{center}
            ...
            \begin{center}
                ...
                \BinaryInfC{$\Gamma \vdash \prod\limits_{x: A} B(x)\ \type 
                    \equiv \prod\limits_{x:A'}B(x)\ \type$}
                \DisplayProof
            \end{center}
            ...
            \begin{center}
                ...
                \UnaryInfC{$\Gamma \vdash \lambda x\ .\ b(x) \equiv \lambda x\ .\ b'(x) : \prod\limits_{x : A} B(x)$}
                \DisplayProof
            \end{center}
            ...
            \begin{center}
                \AxiomC{$\Gamma \vdash f : \prod\limits_{x : A} B(x)$}
            ...
            \begin{center}
                \AxiomC{$\Gamma \vdash b : \prod\limits_{x : A} B(x)$}
                \UnaryInfC{$\Gamma \vdash \lambda x\ .\ b(x) \equiv b : \prod\limits_{x : A} B(x)$}
                \DisplayProof
            \end{center}
        \end{definition}
        ...
        \begin{center}
            ...
            \BinaryInfC{$\Gamma, x : A \vdash B\ \type$}
            \UnaryInfC{$\Gamma \vdash \prod\limits_{x : A} B\ \type$}
            \DisplayProof
        \end{center}
        ...
        \begin{center}
            ...
            \UnaryInfC{$\Gamma \vdash \lambda x\ .\ b(x) : \prod\limits_{x : A} B$}
            \DisplayProof
        \end{center}
        ...
        \begin{definition}[tipo de funciones]
            ...
            \begin{center}
                ...
                \BinaryInfC{$\Gamma, x : A \vdash B\ \type$}
                \UnaryInfC{$\Gamma \vdash \prod\limits_{x : A} B\ \type$}
                \UnaryInfC{$\Gamma \vdash A \rightarrow B := \prod\limits_{x : A} B\ \type$}
                \DisplayProof
            \end{center}
        \end{definition}
