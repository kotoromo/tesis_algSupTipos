...
\begin{exercise}
    Considere la regla de eliminación $\lor_E$. De una interpretación para la regla antes mencionada si $C = A$ y $B = \bot$ y si $C = B$ y $A = \bot$.
\end{exercise}
...
\begin{exercise}
    ...
    \begin{definition}
        ...
        \begin{prooftree}
            \AxiomC{$h : A \land (B \land C)$}
            \RightLabel{$\land$-asoc-izq}
            \UnaryInfC{$\land\text{-assoc-izq}\ h : (A \land B) \land C$}
        \end{prooftree}
    \end{definition}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{definition}
        ...
        \begin{prooftree}
            \AxiomC{$h : (A \land B) \land C$}
            \RightLabel{$\land$-asoc-der}
            \UnaryInfC{$\land\text{-asoc-der}\ h : A \land (B \land C)$}
        \end{prooftree}
    \end{definition}
\end{exercise}
...
\begin{exercise}
    ...
    \begin{prooftree}
        \AxiomC{$f : A \wedge (B \wedge (C \wedge D)) \supset (A \wedge B) \wedge (C \wedge D)$}
        \AxiomC{$\picopar{\alpha, \picopar{\beta, \picopar{\gamma, \delta}}}:A \wedge (B \wedge (C \wedge D))$}
        \BinaryInfC{$f\ \picopar{\alpha, \picopar{\beta, \picopar{\gamma, \delta}}}:\ ?$}
    \end{prooftree}

    \begin{prooftree}
        \AxiomC{$g : (A \wedge B) \wedge (C \wedge D) \supset A \wedge (B \wedge (C \wedge D))$}
        \AxiomC{$f\ \picopar{\alpha, \picopar{\beta, \picopar{\gamma, \delta}}}:\ ?$}
        \BinaryInfC{$g\ (f\ \picopar{\alpha, \picopar{\beta, \picopar{\gamma, \delta}}}) :\ ??$}
    \end{prooftree}

    \begin{prooftree}
        \AxiomC{$g : (A \wedge B) \wedge (C \wedge D) \supset A \wedge (B \wedge (C \wedge D))$}
        \AxiomC{$\picopar{\picopar{\alpha, \beta}, \picopar{\gamma, \delta}} : (A \wedge B) \wedge (C \wedge D)$}
        \BinaryInfC{$g\ \picopar{\picopar{\alpha, \beta}, \picopar{\gamma, \delta}}:\ ?$}
    \end{prooftree}

    \begin{prooftree}
        \AxiomC{$f : A \wedge (B \wedge (C \wedge D)) \supset (A \wedge B) \wedge (C \wedge D)$}
        \AxiomC{$g\ \picopar{\picopar{\alpha, \beta}, \picopar{\gamma, \delta}}:\ ?$}
        \BinaryInfC{$f\ (g\ \picopar{\picopar{\alpha, \beta}, \picopar{\gamma, \delta}}) :\ ??$}
    \end{prooftree}
...
\begin{example}
    ...
    \begin{prooftree}
        \AxiomC{$h : A \land B$}
        \RightLabel{$\land$-conm}
        \UnaryInfC{$\land\text{-conm}\ h : B \land A$}
        \RightLabel{$\supset_I$}
        \UnaryInfC{$(\lambda x\ .\ \land\text{-conm}(x) ): (A \land B) \supset (B \land A)$}
    \end{prooftree}

    Observe que la suposición $h : A \land B$ fue descargada al momento de aplicar la regla de introducción. \todo{incluir este comentario?}
\end{example}
...
\begin{exercise}\label{exercise:ejercicio_prop_univ}
    Demuestre que $((A \supset B) \land (A \supset C)) \supset (A \supset (B \land C))$.
    \newline\textbf{Nos referiremos a este juego posteriormente. Se recomienda por lo menos intentarlo.}
    
    \textit{Sugerencia:} Utilizar los juegos \ref{exercise:product_leftadjoint_logic1} y 
    \ref{exercise:product_leftadjoint_logic2}
    y el ejemplo \ref{example:prop_univ_prod_logica}.
\end{exercise}
...
Ahora le toca divertirse a usted.

\begin{exercise}
    Demuestre que 
    $$
        P \supset (P \wedge P)\text{ y que }(P \wedge P) \supset P.
    $$
\end{exercise}
...
\begin{exercise}
    Demuestre que 
    $$
        (P \lor (P \land Q)) \supset P \text{ y } P \supset (P \lor (P \land Q)).
    $$
\end{exercise}
...
\begin{exercise}
    Demuestre que
    $$
        ((A \lor B) \supset C) \supset ((A \supset C) \land (B \supset C))
    $$
\end{exercise}
...
\begin{exercise}\label{exercise:and-y-neg-implicacion}
    Demuestre que
    $$
...
\todo{TODO Para prox martes tener al menos la mitad de la primera subseccion}
\todo{TODO y tener las subsecciones mejor definidas}
...
%Para las siguientes dos secciones, juntarlas (calculo lambda simplemente tipado)
...
% Dar una embarrada de tipos inductivos
